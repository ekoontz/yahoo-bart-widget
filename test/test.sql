SELECT A_station.name AS from_station,A_bound_to.name AS bound_to1,A_line_from.color,       B_station.name AS transfer_at,       D_bound_to.name AS bound_to2,D_station.name AS final_destination,       C_line_from.color,       (A.distance - B.distance) + (C.distance - D.distance)            
       FROM d_before A     
